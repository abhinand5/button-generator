// Global variable of created button that contains the html/css code for the button created
var buttonFinal;
  ...
  _createClass(ButtonGen, [
    {
      ...
      value: function spectrumConfigGen(color) {
        var _this = this;
        return {
          color: color,
          showInput: true,
    ...
    {
      key: "loadDefaults",
      value: function loadDefaults(config) {
        var _this3 = this;
        ...
        try {
          for (
            var _iterator = config.entries()[Symbol.iterator](), _step;
    ...
    },
    {
      ...
      value: function generate() {
        ...
        var output =
          ...
          results["background-color"] +
          "; margin: auto; max-width: 600px; -webkit-border-radius: " +
          results["border-radius"] +
          "px; -moz-border-radius: " +
          results["border-radius"] +
          "px; border-radius: " +
          results["border-radius"] +
          'px; padding: 15px 20px; " width="100%">\n           <!--[if mso]>&nbsp;<![endif]-->\n               <a href="' +
          results.href +
          '" target="_blank" style="' +
          results["font-size"] +
          "px; font-family: " +
          ...
          "; color: " +
          results.color +
          "; font-weight:normal; text-align:center; background-color: " +
          results["background-color"] +
          "; text-decoration: none; border: none; -webkit-border-radius: " +
          results["border-radius"] +
          "px; -moz-border-radius: " +
          results["border-radius"] +
          "px; border-radius: " +
          ...
          "; color: " +
          results.color +
          '; font-weight:normal; line-height:1.5em; text-align:center;">' +
          results.text +
          "</span>\n             </a>\n           <!--[if mso]>&nbsp;<![endif]-->\n           </td>\n         </tr>\n       </table>\n     </td>\n   </tr>\n </table>\n</center>";
...
// Optional: Log the result to console
console.log(buttonFinal);